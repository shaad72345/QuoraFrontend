...
import AnswerContainer from '../Components/Faizan\'s Components/AnswerContainer';
        ...
        <>
            ...
            {/* {postdata?.map((elem) => { */}
                ...
                <Box display="flex" gap="0.5rem" alignItems="center" p="0.6rem 0.5rem">
                    ...
                    <Box>
                        <Text fontSize="xs" as="b">{props.userId.name}</Text>
               ...
               { props.Post_Image ? <AspectRatio ratio={4 / 3} mt="0.6rem" borderTop="0.2px solid lightgray" borderBottom="0.2px solid lightgray">
                ...
                <Box display="flex" p="0.2rem 0.5rem" alignItems="center">
                    <Box display="flex" p="0.2rem 0.5rem" alignItems="center" gap="0.8rem">
                        ...
                        <IconButton borderRadius='5rem' size='sm' isAttached variant='outline' onClick={handleComment(props._id)} icon={<FaRegComment />} />
                        <IconButton borderRadius='5rem' size='sm' isAttached variant='outline' icon={<BsArrowRepeat />} />
                    <Link to ={`/delete/${props._id}`}><Button>Delete</Button></Link>
