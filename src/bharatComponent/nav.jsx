import { Box, Flex, HStack, Image, Popover, PopoverArrow, PopoverContent, PopoverTrigger, Portal, Spacer, Text, VStack } from '@chakra-ui/react'
...
const Navbar = () => {
    ...
    const { postuser, setinputdata, postdata, inputdata, setIsAuth } = useContext(AuthContext);
            let {Name,setLogin} = useContext(myContext);
        ...
        function handleSignOut() {
          function handlNavi() {
            setIsAuth(false)
            setLogin("");
            localStorage.removeItem("Quora_token");
            navi("/");
          }
          const auth = getAuth();
          signOut(auth)
        ...
        <Box py='0px' border={'0.5px solid #E0E0E0'} bg={'white'} top={'0'} position={'fixed'}  w={'100%'} zIndex='1'>
            <Box w={{base:'100%', md:'100%'}} margin={'auto'} textAlign={'center'}   >
                <Flex align='center' className='hello' display={{base:'none', md:'inline-flex'}} padding={'0px 10px'}>
                    ...
                    <Spacer />
                    <Link><Image maxWidth='30px' minWidth='30px' mr='10px' src={spaces} /></Link>
                    <Spacer />
                    <Link><Image maxWidth='30px' minWidth='30px' mr='10px' src={notification} /></Link>
                    <Spacer />
                        ...
                        <Portal>
                            <PopoverContent mt='15px' width='270px' borderRadius={0} boxShadow='dark-lg' >
                                ...
                                <Box pt='22px' pl='15px' pb='18px' textAlign='left'>
                                    <Link to="/profile">
                                        <Image mr='11px' w='43px' src='data:image/png;base64,' />
                                        <Box pt='10px'><Text fontSize='18px'><strong>{Name}</strong></Text></Box>
                                ...
                                <Box px='10px' py='10px' >
                                    ...
                                    <HStack py='5px'>
                                        ...
                                        <Link to="/myposts"><Text fontSize='sm'>Your content & stats</Text></Link>
                                    </HStack>
                ...
                <Flex align='center' className='hello' width='100%' backgroundColor='#b92b27' display={{base:'inline-flex', md:'none'}} margin='auto' padding={'0px 10px'}>
                    ...
                    <Popover >
                        <PopoverTrigger >
                            <Image mr='10px' w='25px' borderRadius='20px' src='data:image/png;base64,' />
                        </PopoverTrigger>
                        <Portal>
                            <PopoverContent mt='15px' width='270px' borderRadius={0} boxShadow='dark-lg' >
                                <PopoverArrow />
